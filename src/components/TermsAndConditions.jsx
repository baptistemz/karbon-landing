  ...
  return(
    <div>
      <h2>Terms &amp; Conditions</h2> <p>By downloading or using the app, these terms will automatically apply to you – you should make sure
        ...
        property rights related to it, still belong to Baptistemz.</p> <p>Baptistemz is committed to ensuring that the app is as useful and efficient as possible. For
        ...
        to you exactly what you’re paying for.</p> <p>The Karbon app stores and processes personal data that you have provided to us, in order to provide
        ...
        the Karbon app won’t work properly or at all. </p> <p>You should be aware that there are certain things that Baptistemz will not take responsibility
        for. Certain functions of the app will require the app to have an active internet connection. The connection
        can be Wi-Fi, or provided by your mobile network provider, but Baptistemz cannot take responsibility
      ...
      charges, including roaming data charges if you use the app outside of your home territory (i.e. region
        ...
        payer for using the app.</p> <p>Along the same lines, Baptistemz cannot always take responsibility for the way you use
        the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
        you can’t turn it on to avail the Service, Baptistemz cannot accept responsibility.</p> <p>With respect to Baptistemz’s responsibility for your use of the app, when you’re using
        ...
        it available to you. Baptistemz accepts no liability for any loss, direct or indirect,
        you experience as a result of relying wholly on this functionality of the app.</p> <p>At some point, we may wish to update the app. The app is currently available on iOS – the
        requirements for system(and for any additional systems we decide to extend the availability
          ...
          app. Baptistemz does not promise that it will always update the app so that it is relevant
      ...
      to contact me.
    </p> <p>This Terms and Conditions page was generated by <a href="https://app-privacy-policy-generator.firebaseapp.com/" target="_blank" rel="noopener noreferrer">App Privacy Policy Generator</a></p>
    </div>
  )
}
