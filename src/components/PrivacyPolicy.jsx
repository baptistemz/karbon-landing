...
const PrivacyPolicy = () => {
  return(
    <div>
      ...
      <p> Baptistemz built the Karbon app as a Free app. This SERVICE is provided by
        Baptistemz at no cost and is intended for use as is.
      </p>
      ...
      <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
        accessible at Karbon unless otherwise defined in this Privacy Policy.
      </p>
      ...
      <p>The app does use third party services that may collect information used to identify you.</p> <div>
        <p>Link to privacy policy of third party service providers used by the app</p> <ul><li><a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer">Google Play Services</a></li></ul></div>
