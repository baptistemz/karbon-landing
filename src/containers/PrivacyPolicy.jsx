  ...
  return(
    <div>
      <div className="legacy-page">
        ...
        <h2>Gestion des données personnelles et des cookies</h2>
        <h3>Préambule</h3>
        <p>
        ...
        <h3>Définitions</h3>
        <p>
          <b>Utilisateur :</b> désigne la personne physique qui effectue l’une ou l’autre des activités suivantes :
          <ul>
            <li>
          ...
          <b>Application :</b> désigne l’application commercialisée sous la dénomination <b>« Karbon »</b> téléchargeable sur Ios et sur Androïd qui permet à l’Utilisateur de scanner le code barre des produits alimentaires qu’il souhaite acheter ou qu’il consomme afin d’être informé sur leur indice carbone.

          <b>Commande :</b> désigne tout acte de téléchargement de l’Application ou de ses mises à jour effectué par l’Utilisateur.
        ...
        <p>
          <b>Le Responsable du traitement collecte les Données suivantes selon les modalités décrites ci-après :  </b>
          <ul>
            <li>
              <b>Nom, prénom, adresse de courrier électronique :</b> ces Données sont collectées afin de permettre à l’Utilisateur de télécharger l’Application puis de bénéficier de ses fonctionnalités et/ou de recevoir la newsletter.
            </li>
            <li>
              <b>Date de naissance :</b> cette donnée est collectée afin de vérifier que l’Utilisateur est autorisé à conclure un contrat et donc de télécharger l’Application.
            </li>
            <li>
              <b>Mot de passe :</b> lors de la création de son compte, l’Utilisateur doit créer un mot de passe qui est ensuite crypté avant d’être stocké dans la base de données du Responsable du traitement.
            </li>
            <li>
            <b>Produits scannés par l’Utilisateur :</b> ces données permettent à l’Utilisateur de conserver la liste des produits scannés et les notes desdits produits correspondant à leur indice carbone, ainsi que d’alimenter la liste permettant ainsi à l’Utilisateur d’ajouter des produits à son empreinte carbone mensuelle.
            </li>
          </ul>
        </p>
        <h4>
        ...
        <p>
          <b>Le traitement des Données a pour finalités :  </b>
          <ul>
            <li>
        ...
        <p>
          ...
          <ul>
            <li>
              <b>Droit d’accès :</b> à savoir le droit pour l’Utilisateur de demander à obtenir la liste des Données traitées par le Responsable du traitement ;
            </li>
            <li>
              <b>Droit de rectification :</b> à savoir le droit de demander que des informations inexactes ou incomplètes soient corrigées ;
            </li>
            <li>
              <b>Droit à l’effacement (« droit à l’oubli ») :</b> à savoir, le droit de demander la suppression des Données en cas de désinstallation de l’Application ou de désinscription à la newsletter, sauf en cas de nécessité pour le Responsable du traitement de conserver les Données pour la constatation, l’exercice ou la défense de ses droits en justice ;
            </li>
            <li>
              <b>Droit de retrait du consentement :</b> le droit de l’Utilisateur de retirer son consentement au traitement des Données pour des raisons légitimes, c’est-à-dire pour des raisons autres que celles liées à la Commande ;
            </li>
            <li>
              <b>Droit d’opposition :</b> à savoir, le droit de s’opposer, pour des raisons légitimes, à l’utilisation des Données ;
            </li>
            <li>
              <b>Droit à la portabilité des Données :</b> à savoir, la possibilité d’obtenir et de réutiliser à des fins personnelles les informations dont le Responsable du traitement dispose et d’en demander le transfert à un autre responsable de traitement et/ou d’en demander une copie, lorsque cela est techniquement possible ;
            </li>
            <li>
              <b>Droit à la limitation :</b> à savoir le droit pour l’Utilisateur de contester l’exactitude des Données et demander au Responsable du traitement de ne plus traiter les données pendant le délai de vérification ce l’exactitude, la limitation de l’utilisation des données en cas d’illicéité du traitement ; la conservation des Données afin de permettre à l’Utilisateur la constatation, l’exercice ou la défense de ses droits en justice ;
            </li>
            <li>
              <b>Droit de porter une réclamation :</b> le droit d’introduire une réclamation auprès de la Commission nationale de l’informatique et des libertés (CNIL) ou de son autorité locale de protection des données si l’Utilisateur ne réside pas en France.
            </li>
          </ul>
          <br/><br/>
          ...
          <br/><br/>
          L’exercice de ces droits peut également être formulé par téléphone en appelant au numéro suivant : +33 6 79 78 84 68.
        </p>
        <h3>
        ...
        <h3>Utilisation de cookies – consentement de l’Utilisateur </h3>
        <h4>Définition</h4>
        <p>
          ...
          <br/><br/>
          <b>Le consentement de l’Utilisateur est valable pour une durée de TREIZE mois.</b>
        </p>
        <h4>Type de cookies utilisés et consentement de l’Utilisateur</h4>
        <p>
          ...
          <ul>
            <li>
              <b>Les cookies techniques :</b> il s’agit des cookies indispensables à la navigation et permettant une utilisation des services proposés sur le Site et l’Application, tels que l’enregistrement des identifiants du Compte-Utilisateur.
            </li>
            <li>
              <b>Les cookies de mesure d’audience :</b> il s’agit des cookies permettant de mesurer l’utilisation et les performances du Site et de l’Application, d’établir des statistiques, des volumes de fréquentation et d’utilisation des services du Site et de l’Application (contenus visités, parcours de l’Utilisateur) à des fins d’optimiser l’ergonomie du Site et de l’Application et enrichir l’offre de services.
            </li>
          </ul>
          <br/><br/>
          A l’exception des cookies techniques, l’Utilisateur doit donner son consentement à l’utilisation des cookies d’audience et peut donc les accepter ou les refuser en cliquant sur la page de paramétrage ci-après : <a href="/cookies_settings">https://www.karbon.earth/cookies_settings</a>.
        </p>
        <h3>
          Transfert des Données hors Union européenne
        </h3>
        <p>
          Les Données sont stockées sur les serveurs informatiques du Responsable du traitement situés en Union Européene.
          <br/><br/>
          La liste de diffusion permettant d’envoyer la newsletter et comportant les adresses emails des Utilisateurs inscrits à la newsletter est hébergée sur les serveurs du Responsable du traitement The Rocket Science Group LLC, dont le siège social est situé : 675 Ponce de Leon Ave NE, Suite 5000 Atlanta, GA 30308 USA et qui édite la plateforme de marketing online : Mailchimp.com
          <br/>
